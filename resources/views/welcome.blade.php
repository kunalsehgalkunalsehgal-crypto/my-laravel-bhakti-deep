            ...
            <div class="container site-nav">
                ...
                <div class="collapse navbar-collapse" id="mainMenu">
                    <ul class="navbar-nav mx-auto main-links">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#diya-wall">Light Diya</a></li>
                        <li class="nav-item"><a class="nav-link" href="#categories">Book Pooja</a></li>
                        <li class="nav-item"><a class="nav-link" href="#categories">Book Hawan</a></li>
                        <li class="nav-item"><a class="nav-link" href="#live-session">Live Aarti</a></li>
    ...
    <main>
            ...
            <div class="container hero-container">
                <div class="row align-items-center g-5">
                    <div class="col-lg-6">
                        ...
                        <p class="hero-text">
                            Light a virtual diya, book a personalized pooja, or join a live hawan. Experience divine blessings with sankalp, mantra, aarti and family participation - all in one beautiful digital temple.
                        </p>
                        ...
                        <div class="row g-3 hero-features">
                            @foreach ([
                                ['bi-phone', 'Mobile OTP Login', 'Easy & Secure'],
                                ['bi-shield-check', 'Secure Donation', '100% Protected'],
                                ['bi-people', 'Family Join', 'Connect Together'],
                                ['bi-stars', 'AI Mantra Engine', 'Personalized for you'],
                            ] as $feature)
                    ...
                    <div class="col-lg-6">
                        <div class="hero-visual-wrap">
                            ...
                            <div class="hero-image">
                                <img src="{{ asset('assets/temple-hero.jpg') }}" alt="Glowing virtual temple arch with diyas">
                            </div>
                ...
                <div class="glass diya-panel">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6">
                            ...
                            <p>Every flame carries a devotee's intention. Light yours and join a global circle of bhakti - your diya stays lit for the duration you choose.</p>

                            <div class="diya-grid">
                                @for ($i = 0; $i < 48; $i++)
                                    <span class="{{ $i % 5 === 0 ? 'dim' : '' }}"></span>
                                @endfor
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="diya-form">
                                ...
                                <div class="note-box"><i class="bi bi-stars"></i> Your diya will be visible to family via a share link with live burn timer.</div>
                                <button class="btn btn-saffron w-100 mt-3"><i class="bi bi-fire"></i> Light My Diya</button>
                                <p class="small-note">Your diya will appear on the wall instantly with a soft glow.</p>
                            </div>

                            <div class="recent-diyas">
                                <div class="recent-head"><span>Recent diyas</span><span><i class="bi bi-clock"></i> burns left</span></div>
                                @foreach ([['Ananya S.', 'Health', '1d'], ['Rohit K.', 'Prosperity', '12h'], ['Meera P.', 'Family', '6h'], ['Vikram J.', 'Business', '3h'], ['Sunita R.', 'Peace', '1h'], ['Devansh M.', 'Studies', '30m']] as $diya)
                                    <div class="recent-row">
                                        ...
                                        <div><strong>{{ $diya[0] }}</strong><small>{{ $diya[1] }}</small></div>
                                        <em>{{ $diya[2] }}</em>
                                    </div>
                                @endforeach
                            </div>
        ...
        <section class="category-section" id="categories">
            <div class="container">
                <div class="row g-4">
                    @foreach ([
                        ['assets/diya.jpg', 'Diya', ['Standard Diya', 'Akhand Diya', 'Festival Diya', 'Family Diya', 'Business Prosperity Diya', 'Health Protection Diya'], 'Light Your Diya', false],
                        ['assets/lakshmi-hero.jpg', 'Pooja', ['Lakshmi Pooja', 'Shiv Pooja', 'Hanuman Pooja', 'Durga Pooja', 'Ganesh Pooja', '& More Poojas'], 'Book Personalized Pooja', true],
                        ['assets/havan-live.jpg', 'Hawan', ['Mahamrityunjaya Hawan', 'Lakshmi Hawan', 'Navgrah Hawan', 'Vastu Hawan', 'Protection Hawan', '& More Hawans'], 'Book Hawan Session', false],
                    ] as $card)
                        <div class="col-lg-4">
                            <div class="category-card glass {{ $card[4] ? 'featured' : '' }}">
                                <div class="row g-4">
                                    <div class="col-md-5 col-lg-12 col-xl-5">
                                        <div class="category-img"><img src="{{ asset($card[0]) }}" alt="{{ $card[1] }}"></div>
                                    </div>
                                ...
                                <button class="btn btn-saffron w-100 mt-4">{{ $card[3] }} <i class="bi bi-chevron-right"></i></button>
                            </div>
                        </div>
                    @endforeach
                </div>
        ...
        <section class="experience-section">
            <div class="container">
                ...
                <div class="row g-4">
                    @foreach ([
                        ['assets/lakshmi-hero.jpg', 'Lakshmi Pooja', 'Gold · Lotus · Prosperity'],
                        ['assets/shiv.jpg', 'Shiv Pooja', 'Kailash · Om Namah Shivaya'],
                        ['assets/hanuman.jpg', 'Hanuman Pooja', 'Saffron · Power · Bhakti'],
                        ['assets/havan-live.jpg', 'Hawan Experience', 'Fire · Mantra · Shanti'],
                    ] as $item)
        ...
        <section class="steps-section" id="how-it-works">
            <div class="container">
                <div class="glass steps-panel">
                    ...
                    <div class="row g-4">
                        @foreach ([
                            ['bi-globe', 'Visit Website', 'Explore services, live diya wall & festival offers'],
                            ['bi-phone', 'Login with OTP', 'Enter mobile number and verify OTP'],
                            ['bi-grid', 'Choose Service', 'Select Diya, Pooja or Hawan'],
                            ['bi-file-text', 'Fill Sankalp', 'Fill personal details and purpose'],
                            ['bi-heart', 'Donate', 'Choose amount and complete payment'],
                            ['bi-fire', 'Join Live Session', 'Experience pooja, mantra, aarti & blessings'],
                        ] as $step)
                    ...
                    <div class="col-lg-8">
                        <div class="live-session-card">
                            ...
                            <div class="live-session-content">
                                ...
                                <div class="aarti-time"><span><i class="bi bi-bell"></i> Aarti starts in</span><strong class="gold-text">08:24</strong></div>
                                <div class="row g-2 session-options">
                                    @foreach ([['bi-music-note', 'Live Mantra', 'Audio'], ['bi-clipboard-check', 'Session', 'Progress'], ['bi-heart', 'Family', 'Join'], ['bi-fire', 'Donate', 'Now']] as $option)
                                        <div class="col-3"><div><i class="bi {{ $option[0] }}"></i><strong>{{ $option[1] }}</strong><span>{{ $option[2] }}</span></div></div>
                                    @endforeach
                                </div>
                                <button class="btn btn-saffron w-100 mt-3">Explore Live Sessions <i class="bi bi-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
        ...
        <section class="scroll-section">
            <div class="container">
                <div class="section-heading">
                    <div><span>Testimonials</span><h2>Loved by <span class="gold-text">Devotees</span></h2></div>
                    <p>← swipe →</p>
                </div>
                <div class="horizontal-scroll">
                    @foreach ([
                        ['Priya Sharma', 'Jaipur, Rajasthan', 'BhaktiDeep ne hume ghar baithe ek real temple jaisa experience diya.'],
                        ['Rahul Verma', 'Mumbai, Maharashtra', 'The live hawan session felt so divine and personal.'],
                        ['Ananya Gupta', 'Delhi NCR', 'Lighting an akhand diya for my parents health gave me so much peace.'],
                        ['Vikram Joshi', 'Pune', 'Booked a Lakshmi Pooja for our business. The pandit was knowledgeable.'],
                        ['Meera Patel', 'Ahmedabad', 'Finally a digital temple that feels premium and calming.'],
                    ] as $review)
                        <div class="glass review-card">
                            <i class="bi bi-quote"></i>
                            <p>"{{ $review[2] }}"</p>
                            <div><span>{{ collect(explode(' ', $review[0]))->map(fn($n) => $n[0])->join('') }}</span><strong>{{ $review[0] }}<small>{{ $review[1] }}</small></strong><em>★★★★★</em></div>
                        </div>
                    @endforeach
                </div>
            </div>
        ...
        <section class="scroll-section" id="blogs">
            <div class="container">
                <div class="section-heading">
                    <div><span>Read</span><h2>Spiritual Guides &amp; <span class="gold-text">Blogs</span></h2><p>Inspiring stories, festival guides, and timeless spiritual knowledge.</p></div>
                    <button class="btn btn-ghost-gold d-none d-md-inline-flex"><i class="bi bi-book"></i> Read All</button>
                </div>
                <div class="horizontal-scroll">
                    @foreach ([
                        ['assets/diya.jpg', 'DIYA', 'Why You Should Light a Diya Daily?', 'Discover the spiritual significance of the daily diya.'],
                        ['assets/lakshmi-hero.jpg', 'POOJA', 'Importance of Lakshmi Pooja', 'Invite prosperity into every corner of your home.'],
                        ['assets/havan-live.jpg', 'HAWAN', 'Mahamrityunjaya Hawan Benefits', 'Sacred fire for health, protection, and longevity.'],
                        ['assets/shiv.jpg', 'POOJA', 'Shiv Pooja Step-by-Step', 'The complete guide to Mondays with Mahadev.'],
                    ] as $blog)
                        <a class="blog-card">
                            <div><img src="{{ asset($blog[0]) }}" alt="{{ $blog[2] }}"><span>{{ $blog[1] }}</span></div>
                            <h3>{{ $blog[2] }}</h3>
                            <p>{{ $blog[3] }}</p>
                ...
                <div class="journey-panel">
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-7">
                            ...
                            <p>Light a diya, book a personalized pooja, or join a live hawan - and feel divine blessings flow into your home.</p>
                            <div class="hero-buttons">
                                <button class="btn btn-saffron btn-lg"><i class="bi bi-fire"></i> Light Diya</button>
                                <button class="btn btn-gold btn-lg">Book Pooja</button>
                                <button class="btn btn-ghost-gold btn-lg"><i class="bi bi-fire"></i> Book Hawan</button>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-3">
                    ...
                    <div class="socials"><a><i class="bi bi-facebook"></i></a><a><i class="bi bi-instagram"></i></a><a><i class="bi bi-youtube"></i></a><a><i class="bi bi-whatsapp"></i></a></div>
                </div>
                @foreach ([
